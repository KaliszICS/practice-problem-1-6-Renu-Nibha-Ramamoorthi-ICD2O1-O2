...
def q2():
  num1 = int(input("Enter the first integer (divided): "))
  num2 = int(input("Enter the second integer (divided): "))
  quotient = num // num2 	
  print("The quotient rounded down is:", quotien)
...
def q4():
  ...
  result = num1 * num2
  print("The product rounded down is:", rounded_result)	
